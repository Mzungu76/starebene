...
Se dopo il login non vedi `/app` e rimani bloccato su `/login`, nella quasi totalità dei casi manca la configurazione auth:

- `NEXTAUTH_SECRET`
- `AUTH_LOGIN_EMAIL`
- `AUTH_LOGIN_PASSWORD`

Verifica che siano valorizzate nel file `.env` (locale) o nelle variabili ambiente del deploy.
